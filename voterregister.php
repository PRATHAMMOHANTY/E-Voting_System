...
10px 20px
20px;background-color:rgb(0,0,0);margin: 40px 0px 0px 150px;" name="name1"
method="post" action="<?php
echo $_SERVER['PHP_SELF'];?>" align="center">
...
<td style="color:rgb(255, 255, 255);">:<input type="text" name="tb"
style="color:rgb(0, 0,
0);border-radius:4px;
border:1px solid black"></td>
</tr>
...
$result1 = mysqli_query($con,"INSERT INTO voter
xxxii
(name,username,password,voterid,dateofbirth,phoneno,address)
VALUES ('$a3','$a1','$a2','$a4','$a5','$a6','$a7');"); 
} 
if($count!=1 && $count1==2){ 
